...
call_1: "» बोट को <b>लिंक के माध्यम से उपयोगकर्ताओं को आमंत्रित करने</b> की अनुमति की आवश्यकता होती है ताकि सहायक को आपकी चैट में आमंत्रित किया जा सके।"
call_2: "<u>{0} सहायक आपके समूह/चैनल में प्रतिबंधित है।</u>\n\n<b>आईडी :</b> <code>{1}</code>\n<b>नाम :</b> {2}\n<b>उपयोगकर्ता नाम :</b> @{3}\n\nकृपया सहायक को अनबैन करें और पुनः प्रयास करें।"
...
admin_6: "➻ प्रसारण रोका 🎄\n│ \n└द्वारा : {0} 🥀\n\n<b>» {1} में अब कोई और ट्रैक कतार में नहीं है, वीडियोचैट छोड़ रहे हैं।</b>"
admin_7: "स्ट्रीम {0} को बदलते समय त्रुटि।"
admin_8: "» कृपया लूप प्ले को अक्षम करें और फिर से स्किप का प्रयास करें। <code>/loop disable</code> के माध्यम से लूप प्ले को अक्षम करें।"
...
admin_24: "<b>सीक किया जा रहा है...</b>\n\nकृपया प्रतीक्षा करें..."
...
admin_37: "सफलतापूर्वक <code>{0}</code> अपवोट प्राप्त किए गए।"
admin_38: "» 1 अपवोट जोड़ा गया।"
admin_39: "» 1 अपवोट हटा दिया गया।"
admin_40: "अपवोट किया गया।"

start_1 : "{0} जिंदा है बेबी।\n\n<b>✫ उपकाल :</b> {1}"
start_2 : "<b>हे</b> {0}, 🥀\n\n๏ यह {1} है !\n\n➻ एक तेज़ और शक्तिशाली टेलीग्राम संगीत प्लेयर बॉट जिसमें कुछ शानदार सुविधाएँ हैं।\n\n<b><u>समर्थित प्लेटफ़ॉर्म्स :</b></u> यूट्यूब, स्पॉटिफ़ाई, रेसो, एप्पल म्यूज़िक और साउंडक्लाउड।\n──────────────────\n<b>๏ मेरे मॉड्यूल्स और कमांड्स के बारे में जानकारी प्राप्त करने के लिए हेल्प बटन पर क्लिक करें।</b>"
start_3 : "हे {0},\nयह {1} है\n\nआपके द्वारा {2} में मुझे जोड़ने के लिए धन्यवाद, {3} अब इस चैट में गाने बजा सकता है।"
start_4 : "🎄 <b>सुपरग्रुप की आवश्यकता है</b> 🎄\n\nकृपया अपने <b>ग्रुप</b> को <b>सुपरग्रुप</b> में बदलें और फिर मुझे फिर से जोड़ें।\n\n<b>सुपरग्रुप कैसे बनाएं ?</b>\n- अपने ग्रुप की चैट इतिहास को <b>दृश्यमान</b> बनाएं।"
start_5 : "<b>↝ ब्लैकलिस्ट की गई चैट ↜</b>\n\nयह चैट {0} डेटाबेस पर ब्लैकलिस्ट है।\nअपनी चैट को अनब्लैकलिस्ट करने के लिए <a href={1}>सुडो उपयोगकर्ता</a> से अनुरोध करें या <a href={2}>समर्थन चैट पर जाएं।</a>"
start_6 : "😲 <b>ट्रैक जानकारी</b> 😲\n\n📌 <b>शीर्षक :</b> {0}\n\n⏳ <b>अवधि :</b> {1} मिनट\n👀 <b>दृश्य :</b> <code>{2}</code>\n⏰ <b>प्रकाशित हुआ :</b> {3}\n📎 <b>चैनल :</b> <a href={4}>{5}</a>\n\n<u><b>🥀 सर्च पावर्ड बाय {6}</b></u>"

help_1 : "इस ग्रुप के लिए उपयोगकर्ता की मदद के लिए कृपया उपयोगकर्ता जाति को चुनें।\nअपने संदेहों को पूछें <a href={0}>समर्थन चैट में</a>\n\nसभी कमांड्स का उपयोग करने के लिए : <code>/</code>"
...
setting_1 : "<u><b>{0} सेटिंग्स पैनल</b></u>\n\n<b>चैट आईडी :</b> <code>{1}</code>\n<b>चैट टाइटल :</b> {2}\n\nसेटिंग्स बदलने के लिए नीचे दिए गए बटनों पर क्लिक करें."
...
gstats_3: "<b><u>{0} स्टैट्स और इनफ़ोर्मेशन :</u></b>\n\n<b>असिस्टंट्स :</b> <code>{1}</code>\n<b>ब्लॉक्ड :</b> <code>{2}</code>\n<b>चैट्स:</b> <code>{3}</code>\n<b>यूज़र्स :</b> <code>{4}</code>\n<b>मॉड्यूल्स :</b> <code>{5}</code>\n<b>सुडोएर्स :</b> <code>{6}</code>\n\n<b>ऑटो लीविंग असिस्टंट :</b> {7}\n<b>प्ले दुरातिओन लिमिट :</b> {8} मिनट्स"
gstats_4: "इस बट्टन इस ओनली फॉर सुडोएर्स."
gstats_5: "<b><u>{0} स्टैट्स और इनफ़ोर्मेशन :</u></b>\n\n<b>मॉड्यूल्स :</b> <code>{1}</code>\n<b>प्लैटफॉर्म :</b> <code>{2}</code>\n<b>रैम :</b> <code>{3}</code>\n<b>फिजिकल कोर्स :</b> <code>{4}</code>\n<b>टोटल कोर्स :</b> <code>{5}</code>\n<b>सीपीयू फ़्रेक्वेंसी :</b> <code>{6}</code>\n\n<b>पायथन :</b> <code>{7}</code>\n<b>पायरोग्राम :</b> <code>{8}</code>\n<b>पाय-टीजीकैल्स :</b> <code>{9}</code>\n\n<b>स्टोरेज अवेलेबल :</b> <code>{10} गीब</code>\n<b>स्टोरेज यूज़्ड :</b> <code>{11} गीब</code>\n<b>स्टोरेज लेफ्ट :</b> <code>{12} गीब</code>\n\n<b>सर्व्ह्ड चैट्स :</b> <code>{13}</code>\n<b>सर्व्ह्ड यूज़र्स :</b> <code>{14}</code>\n<b>ब्लॉक्ड यूज़र्स :</b> <code>{15}</code>\n<b>सुडो यूज़र्स :</b> <code>{16}</code>\n\n<b>टोटल डीबी साइज़ :</b> <code>{17} एम्बी</code>\n<b>टोटल डीबी स्टोरेज :</b> <code>{18} एम्बी</code>\n<b>टोटल डीबी कलेक्शन्स :</b> <code>{19}</code>\n<b>टोटल डीबी कीज़ :</b> <code>{20}</code>"

playcb_1: "» अव्व, थिस इस नोट फ़ॉर यू बेबी."
playcb_2: "» गेटिंग नेक्स्ट रेसुल्ट,\n\nप्लीज़ वेट..."

cplay_1: "» यू कैन प्ले म्यूज़िक इन चैनल्स फ्रोम {0} तो अन्य चैनल और योर चैट्स लिंकेड चैनल.\n\n<b>फ़ॉर लिंकेड चैनल :</b>\n<code>/channelplay linked</code>\n\n<b>फ़ॉर अन्य चैनल :</b>\n<code>/channelplay [चैनल आईडी]</code>"
cplay_2: "» थिस चैट डोन'ट हेव अन्य लिंकेड चैनल."
cplay_3: "» चैनल डिफ़ाइन्ड टू {0}.\nचैनल आईडी : <code>{1}</code>"
...
cplay_6: "» यू नीड टो बी थे <b>ओव्नर</b> ऑफ थे चैनल {0} टो कन्नेक्ट इट विथ थिस ग्रूप.\n<b>चैनल'स ओव्नर :</b> @{1}\n\nआल्टरनटिवली यू कैन लिंक योर ग्रूप टो थाट चैनल एंड थेन ट्राई कन्नेक्टिंग विथ <code>/channelplay linked</code>"
cplay_7: "» चैनल प्लेय डिसअब्लेड."

play_1: "🔎"
play_2: "<b>➻ चैनल प्लेय मोड</b>\n\nप्रोसेसिंग, प्लीज़ वेट...\n\n<b>लिंकेड चैनल :</b> {0}"
play_3: "» फ़ेल्ड टो प्रोसेस क़ुएरी."
play_4: "<b>एड्मिन्स ओनली प्लेय</b>\nओन्ली एड्मिन्स ऑफ थिस चैट आरे अल्लोवेड टो प्लेय\n\nचेंगे प्लेय मोड विआ /playmode"
play_5: "» फ़ेल्ड टो प्रोसेस ऑडियो फ़िले.\n\nऑडियो फ़िले सिज़े इस लार्जर थान थे डिफ़ाइन्ड लिमिट."
play_6: "» स्ट्रीम'स लोंगेर थान {0} आरें'ट अल्लोवेड टो प्लेय ऑन {1}"
play_7: "» नोट अ वैलिड विडियो फ़िले एक्सटेंशन.\n\n<b>सुप्पोर्टेड एक्सटेंशन्स :</b> {0}"
play_8: "» विडियो फ़िले सिज़े शोल्ड बी लेस थान 1गीब."
play_9: "<b><u>यूट्यूब प्लेयलिस्ट फीचर</b></u>\n\nसेलेक्ट थे मोड इन व्हिच यू वॉन्ट टो प्लेय होले यूट्यूब प्लेयलिस्ट."
play_10: "<b>टाइटल :</b> {0}\n<b>ड्युरेशन :</b> {1} मिनट्स"
play_11: "<u><b>{0} स्पोटिफ़ाई प्लेयर</b></u>\n\nरिक्वेस्टेड बाय : {1}"
play_12: "<u><b>{0} अप्प्ले प्लेयर</b></u>\n\nरिक्वेस्टेड बाय : {1}"
...
play_18: "<b>उपयोग:</b> /play [गाने का नाम/YouTube URL/ऑडियो/वीडियो फ़ाइल का उत्तर]"
play_19: "कतार में जोड़ा गया प्लेलिस्ट:"
play_20: "कतार में स्थिति-"
play_21: "{0} ट्रैक्स को कतार में जोड़ा गया।\n\n<b>जाँच करें:</b> <a href={1}>यहाँ क्लिक करें</a>"
...
ping_2 : "🏓 पोंग : <code>{0}ms</code>\n\n<b><u>{1} सिस्टम स्थिति :</u></b>\n\n↬ अपटाइम : {2}\n↬ रैम : {3}\n↬ सीपीयू : {4}\n↬ डिस्क : {5}\n↬ पायथन-टीजीसीएल : <code>{6}ms</code>"

queue_1 : "» कतार प्राप्त हो रही है...\n\nकृपया प्रतीक्षा करें..."
queue_2 : "» कतार खाली है।"
queue_3 : "<u>» कतार में ट्रैकों की सूची देखने के लिए यहाँ क्लिक करें :</u> <a href={0}>यहाँ</a>"
queue_4 : "➲ <b>कतार में जोड़ा गया #{0}\n\n‣ शीर्षक :</b> {1}\n<b>‣ अवधि :</b> {2} मिनट\n<b>‣ द्वारा अनुरोधित :</b> {3}"
queue_5 : "केवल एक कतार में ट्रैक है।\n\nलिस्ट देखने के लिए अधिक ट्रैक जोड़ें।"
queue_6 : "<b>🕚 अवधि :</b> अज्ञात स्ट्रीम\n\nपूरी कतार की सूची प्राप्त करने के लिए नीचे बटन पर क्लिक करें।"
queue_7 : "\nनीचे बटन पर क्लिक करें।"
queue_8 : "<b>{0} प्लेयर</b>\n\n🎄 <b>स्ट्रीमिंग :</b> {1}\n\n🔗 <b>स्ट्रीम प्रकार :</b> {2}\n🥀 <b>अनुरोधक :</b> {3}\n{4}"

stream_1 : "➲ <b>स्ट्रीमिंग शुरू की गई |</b>\n\n<b>‣ शीर्षक :</b> <a href={0}>{1}</a>\n<b>‣ अवधि :</b> {2} मिनट\n<b>‣ द्वारा अनुरोधित :</b> {3}"
stream_2 : "➲ <b>स्ट्रीमिंग शुरू की गई |</b>\n\n<b>‣ स्ट्रीम प्रकार :</b> लाइव स्ट्रीम [URL]\n<b>‣ द्वारा अनुरोधित :</b> {0}"
...
sudo_5 : "<u><b>🥀 मालिक :</b></u>\n"
sudo_6 : "\n<u><b>✨ सुडो उपयोगकर्ताएँ :</b></u>\n"
...
server_10 : "{0} पर एक अपवाद हुआ #अपडेटर में : <code>{0}</code>"
server_11 : "» एक स्पीड टेस्ट चल रहा है..."
server_12 : "<b>⇆ डाउनलोड स्पीड टेस्ट चल रहा है...</b>"
server_13 : "<b>⇆ अपलोड स्पीड टेस्ट चल रहा है...</b>"
server_14 : "<b>↻ स्पीड टेस्ट परिणाम साझा किए जा रहे हैं...</b>"
server_15 : "✯ <b>स्पीड टेस्ट परिणाम</b> ✯\n\n<u><b>ग्राहक :</b></u>\n<b>» आईपी :</b> {0}\n<b>» देश :</b> {1}\n\n<u><b>सर्वर :</b></u>\n<b>» नाम :</b> {2}\n<b>» देश :</b> {3}, {4}\n<b>स्पॉन्सर :</b> {5}\n<b>लैटेंसी :</b> {6}\n<b>पिंग :</b> {7}"
...
gban_5 : "» {0} पर ग्लोबल बैन को आरंभ किया जा रहा है।\n\n<b>प्रत्याशित समय:</b> {1}"
gban_6 : "<b><u>नया ग्लोबल बैन {0} पर:</u></b>\n\n<b>मूल श्रोत से:</b> {1} [<code>{2}</code>]\n<b>उपयोगकर्ता:</b> {3}\n<b>उपयोगकर्ता आईडी:</b> {4}\n\n<b>द्वारा बैन किया गया:</b> {5}\n<b>चैट्स:</b> </code>{6}</code>"
...
gban_12 : "🙂 <b>ग्लोबल बैन उपयोगकर्ता :</b>\n\n"
