...
OWNER_USERNAME = getenv("OWNER_USERNAME","Cute_kamina_c")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "Cute_kamina_music")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "Yumikoo")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "cutkamina")
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+tHTkLg_SQ5E4OGRh")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/78e3e4a3abf0aa7896584.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://graph.org/file/78e3e4a3abf0aa7896584.jpg"
)
