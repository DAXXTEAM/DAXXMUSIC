...
ASSUSERNAME = getenv("ASSUSERNAME" , "Sizuka")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/anik_x_suoporttt")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/anik_x_suoporttt")
