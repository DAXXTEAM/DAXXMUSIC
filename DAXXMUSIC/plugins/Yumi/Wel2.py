...
def main():
    # Create the Updater and pass it your bot's BOT_TOKEN.
    updater = Updater(BOT_TOKEN, workers=10, use_context=True)

    # Get the dispatcher to register handlers
    dp = updater.dispatcher

    dp.add_handler(CommandHandler("startss", help))
    dp.add_handler(CommandHandler("helpsss", help))
