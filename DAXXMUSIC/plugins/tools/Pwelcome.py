...
💥️ 𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 › {member.chat.title}
💯 𝐂𝐡𝐚𝐭 𝐖𝐢𝐭𝐡 𝐍𝐞𝐰 𝐏𝐫𝐨 𝐅𝐫𝐢𝐞𝐧𝐝𝐬
...
🌹 𝐓𝐡𝐞𝐧 𝐃𝐌 𝐓𝐨: ||  [ 𓄻꯭|꯭𝐌‌ꝛ꯭𝆺꯭꯭𝅥ᷤ🅿︎꯭α꯭ᷟω꯭ⷶα꯭ᷢη꯭ⷮ𓄻꯭| ](https://t.me/PAWAN_IS_BACK)    ||
**
""",
reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton (f"๏ ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ!", url=f"https://t.me/LOVER_X_MUSIC_BOT?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
