...
async def download_instareels(c: app, m: Message):
    try:
        ...
        await m.reply_text("Give me an link to download it...")
        return
    if not reel_.startswith("https://youtube.com/shorts/"):
        await m.reply_text("In order to obtain the requested , a valid link is necessary. Kindly provide me with the required link.")
        return
    OwO = reel_.split(".",1)
    Reel_ = ".dd".join(OwO)
    try:
        ...
        try:
            ...
            try:
                ...
                await m.reply_text("I am unable to reach to this ")
